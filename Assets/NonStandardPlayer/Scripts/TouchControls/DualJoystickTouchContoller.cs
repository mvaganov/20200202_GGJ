...
public class DualJoystickTouchContoller : MonoBehaviour
{
    ...
    private SingleJoystick leftJoystick; // script component attached to the left joystick's background image
    private SingleJoystick rightJoystick; // script component attached to the right joystick's background image
    ...
    void Start()
    {
        ...
        if (leftJoystickBackgroundImage.GetComponent<SingleJoystick>() == null)
        {
            Debug.LogError("There is no Joystick script attached to the Left Joystick game object.");
        }
        else
        {
            leftJoystick = leftJoystickBackgroundImage.GetComponent<SingleJoystick>(); // gets the left joystick script
        ...
        if (rightJoystickBackgroundImage.GetComponent<SingleJoystick>() == null)
        {
            Debug.LogError("There is no Joystick script attached to Right Joystick game object.");
        }
        else
        {
            rightJoystick = rightJoystickBackgroundImage.GetComponent<SingleJoystick>(); // gets the right joystick script
