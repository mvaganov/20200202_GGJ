...
public class NPCMove : MonoBehaviour {
    ...
    public struct ClickToMoveDetails {
        ...
        public void UpdateClickToMove( ref NPCMoveControls move ) {
...
//		public string horizontalAxisName, verticalAxisName, jumpButtonName;
        ...
        public void ApplyMoveFromInput( NPCMove c ) {
        ...
        public void FixedUpdate( NPCMove c ) {
            if ( isStableOnGround || canMoveInAir ) {
                ApplyMoveFromInput( c );
            }
        }
    }
    public NPCMoveControls move = new NPCMoveControls {
        speed = 5,
    ...
    public class Jumping {
        ...
        public void FixedUpdate( NPCMove p ) {
