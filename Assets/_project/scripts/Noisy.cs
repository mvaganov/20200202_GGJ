...
// latest version at: https://pastebin.com/raw/hGU8et8s -- added: bgmusic fix, trigger functions (2019/05/07)
public class Noisy : MonoBehaviour
{
	...
	public class Noise
	{
		...
		[Range(0, 1), Tooltip("to keep max volume, leave this at 0 (changes during editor runtime work thanks to Noisy.OnValidate())")]
	...
	public static AudioSource PlaySound(AudioClip noise, Vector3 p = default(Vector3), bool is3D = false, bool isLooped = false, string soundCategory = null, float volume = 1f)
	{
